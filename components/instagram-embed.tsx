    ...
    <section className="py-16 md:py-24 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-light text-white tracking-tight mb-4">Instagram</h2>
        ...
        <div ref={containerRef} className="instagram-embed-container max-w-4xl mx-auto">
          {/* Buraya embed kodu gelecek */}
          <blockquote
            className="instagram-media"
            data-instgrm-permalink="https://www.instagram.com/rettocreative/"
            ...
            <div style={{ padding: "16px" }}>
              ...
              >
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  Retto Creative (@rettocreative)
                </a>{" "}
                paylaştığı bir gönderi
              </p>
            </div>
          </blockquote>
        </div>
